...
class SaleType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('dComm', TextType::class, $this->getConfiguration('Commission du dealer', "Saisir la commission du dealer"))
            ->add('posComm', TextType::class, $this->getConfiguration('Commission du PDV', "Saisir la commission du PDV"))
